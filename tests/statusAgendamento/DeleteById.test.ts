...
describe('Status de Agendamento - DeleteById', () => {
    ...
    beforeAll(async () => {
        ...
        const respostaCreate = await testServer
            ...
            .send({
                status: 'Agendamento cancelado pelo profissional'
            })
    ...
    it('Apaga registro', async() => {
        const resposta = await testServer
            .delete(`/statusagendamento/${statusAgendamento}`)
            .send()
