...
export const getAll = async (req: Request<{},{},{}, IQueryProps>, res: Response) => {
    ...
    const result = await ProfissionaisProvider.getAll(req.query.page || 1, req.query.limit || 10, req.query.filterIdPessoa || 0, req.query.filterIdProfessionalTitle || 0, req.query.filterIsActive || true, Number(req.query.id))
    const count = await ProfissionaisProvider.count(<number>req.query.filterIdPessoa, <number>req.query.filterIdProfessionalTitle, <boolean>req.query.filterIsActive)
