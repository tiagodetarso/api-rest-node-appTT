...
export const getAll = async (req: Request<{},{},{}, IQueryProps>, res: Response) => {
    ...
    const result = await StatusAgendamentoProvider.getAll(req.query.page || 1, req.query.limit || 10, req.query.filter || '', Number(req.query.id))
    const count = await StatusAgendamentoProvider.count(<string>req.query.filter)
