...
export const getAll = async (req: Request<{},{},{}, IQueryProps>, res: Response) => {
    ...
    const result = await EnderecosProvider.getAll(req.query.page || 1, req.query.limit || 10,  req.query.filterNumber || 0, req.query.filterNeighborhood || '', Number(req.query.id))
    const count = await EnderecosProvider.count (<number>req.query.filterNumber, <string>req.query.filterNeighborhood)
