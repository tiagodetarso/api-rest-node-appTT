    ...
    try {
        ...
        if (filterIdProfessional === 0 && filterIdClient === 0 && filterIdHorario === 0 && filterIdStatus === 0 && filterIdPaymentStatus === 0) {
            ...
            result = await Knex(ETableNames.agendamento)
                ...
                .offset((page - 1) * limit)
                .limit(limit)
        } else if (filterIdHorario === 0 && filterIdStatus === 0 && filterIdPaymentStatus === 0){
            result = await Knex(ETableNames.agendamento)
                .select('*')
                .where('idProfessional', '=', filterIdProfessional)
                ...
                .offset((page - 1) * limit)
                .limit(limit)
        } else if (filterIdClient === 0 && filterIdStatus === 0 && filterIdPaymentStatus === 0){
            result = await Knex(ETableNames.agendamento)
                .select('*')
                .where('idProfessional', '=', filterIdProfessional)
                ...
                .offset((page - 1) * limit)
                .limit(limit)
        } else if (filterIdClient === 0 && filterIdHorario === 0 && filterIdPaymentStatus === 0){
            result = await Knex(ETableNames.agendamento)
                .select('*')
                .where('idProfessional', '=', filterIdProfessional)
                ...
                .offset((page - 1) * limit)
                .limit(limit)
        } else if (filterIdClient === 0 && filterIdHorario === 0 && filterIdStatus === 0){
            result = await Knex(ETableNames.agendamento)
                .select('*')
                .where('idProfessional', '=', filterIdProfessional)
                ...
                .offset((page - 1) * limit)
                .limit(limit)
        } else if (filterIdProfessional === 0 && filterIdStatus === 0 && filterIdPaymentStatus === 0){
            result = await Knex(ETableNames.agendamento)
                .select('*')
                .where('idClient', '=', filterIdClient)
                .andWhere('idHorario', '=', filterIdHorario)
                .offset((page - 1) * limit)
                .limit(limit)
        } else if (filterIdProfessional === 0 && filterIdHorario === 0 && filterIdPaymentStatus === 0){
            result = await Knex(ETableNames.agendamento)
                .select('*')
                .where('idClient', '=', filterIdClient)
                .andWhere('idStatus', '=', filterIdStatus)
                .offset((page - 1) * limit)
                .limit(limit)
        } else if (filterIdProfessional === 0 && filterIdHorario === 0 && filterIdStatus === 0){
            result = await Knex(ETableNames.agendamento)
                .select('*')
                .where('idClient', '=', filterIdClient)
                .andWhere('idPaymentStatus', '=', filterIdPaymentStatus)
                .offset((page - 1) * limit)
                .limit(limit)
        } else if (filterIdProfessional === 0 && filterIdClient === 0 && filterIdPaymentStatus === 0){
            result = await Knex(ETableNames.agendamento)
                .select('*')
                .where('idHorario', '=', filterIdHorario)
                .andWhere('idStatus', '=', filterIdStatus)
                .offset((page - 1) * limit)
                .limit(limit)
        } else if (filterIdProfessional === 0 && filterIdClient === 0 && filterIdStatus === 0){
            result = await Knex(ETableNames.agendamento)
                .select('*')
                .where('idHorario', '=', filterIdHorario)
                .andWhere('idPaymentStatus', '=', filterIdPaymentStatus)
                .offset((page - 1) * limit)
                .limit(limit)
        } else if (filterIdProfessional === 0 && filterIdClient === 0 && filterIdHorario === 0){
            result = await Knex(ETableNames.agendamento)
                .select('*')
                .where('idStatus', '=', filterIdStatus)
                .andWhere('idPaymentStatus', '=', filterIdPaymentStatus)
